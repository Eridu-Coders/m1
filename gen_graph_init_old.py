...
g_special_vertices = [
    ['FOLDR', ['SI_IS_TYPE', 'SI_IS_SELECTABLE'], 'FOLDER_ICON_PATH', 'FOLDER_SIID', None,
     'Special Vertex ID (Vertex type) of folders (ordinary vertices with no special role)'],
    ['AUTO_', ['SI_IS_TYPE', 'SI_EDGE_TYPE'], 'AUTO_ICON_PATH', 'AUTO_SIID', None,
    ...
    ['OWNS_', ['SI_IS_TYPE', 'SI_EDGE_TYPE',
     ...
     ('BLNGS', ['SI_IS_TYPE', 'SI_EDGE_TYPE',
                'SI_INSERT_AT_TOP', 'SI_IS_SELECTABLE'], 'BLNGS_ICON_PATH', 'BLNGS_SIID'),
    ...
    ['TRSLT', 'SI_IS_TYPE', None, 'TEXT_WORD_TRANSLIT_SIID', None,
     'Special Vertex ID (Simple Edge type) of Gita transliteration field'],
    ['DCTRF', 'SI_IS_TYPE', None, 'TEXT_WORD_DICT_REF_SIID', None,
     'Special Vertex ID (Simple Edge type) of Gita dictionary ref. field'],
    ['TRSLT', 'SI_IS_TYPE', None, 'TEXT_WFW_TRANSLIT_SIID', None,
     'Special Vertex ID (Simple Edge type) of Gita transliteration field'],
    ['WFTRN', 'SI_IS_TYPE', None, 'TEXT_WFW_TRANSLAT_SIID', None,
    ...
    ['WFGRM', 'SI_IS_TYPE', None, 'TEXT_WFW_GRM_SIID', None,
     'Special Vertex ID (Simple Edge type) WfW form Grammatical analysis'],
    ['URLNK', 'SI_IS_TYPE', 'TEXT_URL_LINK_ICON_PATH', 'TEXT_URL_LINK_SIID', None,
     'Special Vertex ID (Vertex type) Url link'],
    # --------------------------- HS2OB / OC2HB ---------------------------
    ['HS2OB', 'SI_IS_TYPE', 'TW_SECTION_2_OCC_BEGIN_ICON_PATH', 'TW_SECTION_2_OCC_BEGIN_SIID',
     ('OC2HB', 'SI_IS_TYPE', 'TW_SECTION_2_OCC_BEGIN_ICON_PATH', 'TW_REV_SECTION_2_OCC_BEGIN_SIID'),
    ...
    ['HS2OE', 'SI_IS_TYPE', 'TW_SECTION_2_OCC_END_ICON_PATH', 'TW_SECTION_2_OCC_END_SIID',
     ('OC2HE', 'SI_IS_TYPE', 'TW_SECTION_2_OCC_END_ICON_PATH', 'TW_REV_SECTION_2_OCC_END_SIID'),
...
g_vertices = [
    ...
    ['Root of all types', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'ROOT_')], 'TYPE_',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'TYPE_NODE_ICON_PATH', 'TYPE_NODE_SIID'],
    ['Texts Work Area', ['FULL_VERTEX', 'IS_SPECIAL'], ['FOLDR'], [('BLNGS', 'HOME_')], 'TXWKK', '0', None,
     'TEXT_WORK_SIID'],
    ['Person (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'PERSN',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE',
      'SI_IS_SELECTABLE'], 'PERSON_ICON_PATH', 'PERS_TYPE_SIID'],
    ['Organization (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'ORGN_',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE',
      'SI_IS_SELECTABLE'], 'ORGANIZATION_ICON_PATH', 'ORG_TYPE_SIID'],
    ['Role folder', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], None, 'RLFLD', ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'],
     'ROLE_FOLDER_ICON_PATH', 'ROLE_FLDR_SIID'],
    ['Texts Root (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'HOME_')], 'TEXT_',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE',
    ...
    ['Inboxes / Message Root Type', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'HOME_')], '_MSG_',
     ['SI_IS_TYPE'], None, 'MSG_TYPE_SIID'],
    ['Me', ['FULL_VERTEX', 'IS_SPECIAL'], ['PERSN'], [('BLNGS', 'HOME_')], 'ME___', '0', None, 'ME_SIID'],
    ['Email Inbox', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', '_MSG_')], 'EMAIL',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], None, 'EMAIL_TYPE_SIID'],
    ['Whatsapp Inbox', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', '_MSG_')], 'WHTSP',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], None, 'WHTSP_TYPE_SIID'],
    ['Discord Inbox', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', '_MSG_')], 'DSCRD',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], None, 'DSCRD_TYPE_SIID'],
    ['GChat Inbox', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', '_MSG_')], 'GCHAT',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], None, 'GCHAT_TYPE_SIID'],
    ['SMS Inbox', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', '_MSG_')], 'SMS__',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], None, 'SMS_TYPE_SIID'],
    ['Grammar Attributes (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'GRATT',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'FOLDER_ICON_PATH', 'GRAMMAR_ATTR_SIID'],
    ['Grammar Attr. Value (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'GRATV',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'FOLDER_ICON_PATH', 'GRAMMAR_ATTR_VAL_SIID'],
    ['Lemma (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'LEMMA',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE',
      'SI_IS_ICON_TYPE'], 'LEMMA_ICON_PATH', 'LEMMA_SIID'],
    ['NLP Entity (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'NLENT',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'ENTITY_ICON_PATH', 'NLENT_SIID'],
    ['NLP Pos code (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'NLPOS',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'POS_ICON_PATH', 'NLPOS_SIID'],
    ['NLP Tag code (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'NLTAG',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'TAG_ICON_PATH', 'NLTAG_SIID'],
    ['Stephanus Section (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'STPSC',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'FOLDER_ICON_PATH', 'STEPHANUS_SIID'],
    ['Text Version (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'TXTVR',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'FOLDER_ICON_PATH', 'TXTVR_SIID'],
    ['Notes (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'TXTNT',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'FOLDER_ICON_PATH', 'TXTNT_SIID'],
    ['Text Chunk (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], None, 'TXTCK', ['SI_IS_TYPE', 'SI_REQUIRES_EDGE',
                                                                                    'SI_IS_SELECTABLE'],
     'TEXT_CHUNK_ICON_PATH', 'TEXT_CHUNK_SIID'],
    ['Book (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'TXTBK',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'BOOK_ICON_PATH', 'TEXT_BOOK_SIID'],
    ['Chapter (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'TXTCH',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'CHAPTER_ICON_PATH', 'TEXT_CHAPTER_SIID'],
    ['Sentence (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], None, 'TXSNT', ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'],
     'SENTENCE_ICON_PATH', 'TEXT_SENTENCE_SIID'],
    ['Sloka (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'TXSLK',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'SLOKA_ICON_PATH', 'SLOKA_SIID'],
    ['Highlight (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'TXHLT',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'HIGHLIGHTER_ICON_PATH', 'TEXT_HIGHLIGHT_SIID'],
    ['Highlight category (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'TXHLC',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], None, 'TEXT_HIGHLIGHT_CAT_SIID'],
    ['Highlight Folder (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], None, 'TXHLF',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], None, 'TEXT_HIGHLIGHT_FLDR_SIID'],
    ['Highlight Categories Folder', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], None, 'TXHCF',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], None, 'TEXT_HIGHLIGHT_CAT_FLDR_SIID'],
    ['Highlight Chunk', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], None, 'TXHCK', ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'],
     "HL_CHUNK_ICON_PATH", 'TEXT_HIGHLIGHT_CHUNK_SIID'],
    ['Sloka folder', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], None, 'SKFLD', ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'],
     "SLOKA_FOLDER_ICON_PATH", 'TEXT_SLOKA_FLDR_SIID'],
    ['Highlight Quotation (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], None, 'TXHQT',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE',
      'SI_EDGE_TYPE', 'SI_IS_SELECTABLE'], "HL_QUOTE_ICON_PATH", 'TEXT_HIGHLIGHT_QUOTE_SIID'],
    ['Sloka Lines (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'SLKLN',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'TEXT_SLOKA_LINE_ICON_PATH', 'TEXT_SLOKA_LINE_SIID'],
    ['INRIA Dictionary Reference', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'INRIA',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'FOLDER_ICON_PATH', 'TEXT_WORD_DREF_INRIA_SIID'],
    ['Sloka Translation (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'SLTRN',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'TEXT_SLOKA_TRANSLATION_ICON_PATH', 'TEXT_SLOKA_TRANSLATION_SIID'],
    ['Sloka Transliteration (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'SLTRL',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'TEXT_SLOKA_TRANSLIT_ICON_PATH', 'TEXT_SLOKA_TRANSLIT_SIID'],
    ['Sloka Bhashya (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'SLBHS',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'TEXT_SLOKA_BHASHYA_ICON_PATH', 'TEXT_SLOKA_BHASHYA_SIID'],
    ['WfW Translation Unit (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'TRLUN',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'TEXT_WFW_UNIT_ICON_PATH', 'TEXT_WFW_UNIT_SIID'],
    ['WfW Form (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'TXWKK')], 'WFFRM',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'TEXT_WFW_FORM_ICON_PATH', 'TEXT_WFW_FORM_SIID'],
]

g_special_vertices_gita = [
    ['PRABH', 'SI_IS_TYPE', None, 'TEXT_WFW_PRABUPADA_SIID', None,
     'Special Vertex ID (Vertex type) of Gita translation source: Prabhupada'],
    ['SIVAN', 'SI_IS_TYPE', None, 'TEXT_WFW_SIVANANDA_SIID', None,
     'Special Vertex ID (Vertex type) of Gita translation source: Sivananda'],
    ['GAMBI', 'SI_IS_TYPE', None, 'TEXT_WFW_GAMBIRANANDA_SIID', None,
     'Special Vertex ID (Vertex type) of Gita translation source: Gambirananda'],
    ['TRSLT', 'SI_IS_TYPE', None, 'TEXT_WORD_TRANSLIT_SIID', None,
     'Special Vertex ID (Simple Edge type) of Gita transliteration field'],
    ['DCTRF', 'SI_IS_TYPE', None, 'TEXT_WORD_DICT_REF_SIID', None,
     'Special Vertex ID (Simple Edge type) of Gita dictionary ref. field'],
    ['WFTRN', 'SI_IS_TYPE', None, 'TEXT_WFW_TRANSL_SIID', None,
     'Special Vertex ID (Simple Edge type) WfW unit Translation field'],
    ['URLNK', 'SI_IS_TYPE', 'TEXT_URL_LINK_ICON_PATH', 'TEXT_URL_LINK_SIID', None,
     'Special Vertex ID (Vertex type) Url link'],
    # --------------------------- HS2OB / OC2HB ---------------------------
...
g_vertices_gita = [
    ['His Divine Grace A. C. Bhaktivedanta Swami Prabhupada', ['FULL_VERTEX', 'IS_SPECIAL'], ['PERSN'],
     [('BLNGS', 'BGRT_')], 'PPRAB', '0', None, None],
    ['Swami Sri Sivananda Saraswati', ['FULL_VERTEX', 'IS_SPECIAL'], ['PERSN'], [('BLNGS', 'BGRT_')], 'PSIVA', '0',
     None, None],
    ['Swami Gambirananda', ['FULL_VERTEX', 'IS_SPECIAL'], ['PERSN'], [('BLNGS', 'BGRT_')], 'PGAMB', '0', None, None],
    ['Sloka (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'BGRT_')], 'TXSLK',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'], 'SLOKA_ICON_PATH', 'SLOKA_SIID'],
    ['Sloka Lines (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'BGRT_')], 'SLKLN',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'],
     'TEXT_SLOKA_LINE_ICON_PATH', 'TEXT_SLOKA_LINE_SIID'],
    ['INRIA Dictionary Reference (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'BGRT_')], 'INRIA',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'],
     'FOLDER_ICON_PATH', 'TEXT_WORD_DREF_INRIA_SIID'],
    ['Sloka Translation (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'BGRT_')], 'SLTRN',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'],
     'TEXT_SLOKA_TRANSLATION_ICON_PATH', 'TEXT_SLOKA_TRANSLATION_SIID'],
    ['Sloka Bhashya (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'BGRT_')], 'SLBHS',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'],
     'TEXT_SLOKA_BHASHYA_ICON_PATH', 'TEXT_SLOKA_BHASHYA_SIID'],
    ['WfW Translation Unit (type)', ['FULL_VERTEX', 'IS_SPECIAL'], ['TYPE_'], [('BLNGS', 'BGRT_')], 'TRLUN',
     ['SI_IS_TYPE', 'SI_REQUIRES_EDGE'],
...
if __name__ == '__main__':
    ...
    for l_label, l_vertex_flag_list, l_type_list, l_edges, l_mnemo, l_si_flag_list, l_icon_path, l_pseudo_constant in g_vertices:
        print(
            f'{l_label:80} {str(l_vertex_flag_list):30} {l_type_list} {str(l_edges):25} {l_mnemo} {str(l_si_flag_list):35} {str(l_icon_path):25} {l_pseudo_constant}')
    ...
    for l_label, l_vertex_flag_list, l_type_list, l_edges, l_mnemo, l_si_flag_list, l_icon_path, l_pseudo_constant in g_vertices:
        ...
        if not l_mnemo:
            ...
            l_si_flag_string = '0' if l_si_flag_list == '0' else ' | '.join(
                [f'M1Env::{l_flag}' for l_flag in l_si_flag_list])
            l_icon_path = f'M1Env::{l_icon_path}' if l_icon_path else 'nullptr'
            l_base_code += (
                    f'        // Special Item flag\n' +
                    f'        {l_si_flag_string},\n' +
